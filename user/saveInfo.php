    ...
    if(!($id = $_SESSION["user_id"])){
            ...
            <?php
            header("Refresh: 0.01; url=../frontEnd/homePage.php");die;
    }
    //取出密码对照判断是否本人操作
    ...
    if (empty($_FILES["pic"]["name"])){
        ...
        //    echo  "文件以保存到：../user/upload/".$_FILES["img"]["name"];
            ...
            <?php
            header("Refresh: 0.01; url=../frontEnd/infoUpdate.php");die;
    }
        if (empty($_POST["snickname"])) {
            ...
            <?php header("Refresh: 0.01; url=../frontEnd/infoUpdate.php");die;
        ...
        //}
            ...
            if ($res) {
                ...
                header('Refresh: 1; url=../frontEnd/userInfo.php');
            } else {
                echo "修改失败！请重试";
                header("Refresh: 1; url=../frontEnd/userInfo.php");
                die;
