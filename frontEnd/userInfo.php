        ...
        <div class="content-right">
            ...
            <div class="info-line">
                ...
                <div class="info-list3">
                    <button type="button" class="btn btn-default" onclick="window.location.href='infoUpdate.php'">修改资料</button>
                    <div>&nbsp</div>
                    <div>&nbsp</div>
                    <button type="button" class="btn btn-default" onclick="window.location.href='homePage.php'" style="width: 82px;height: 32px">返回</button>
                </div>
            </div>
        </div>
    </div>
