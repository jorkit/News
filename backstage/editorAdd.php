...
<div class="right">
    ...
    <div class="right-content">
            <form action="../user/saveUser.php" method="post" enctype="multipart/form-data">
                <input name="srole_id" type="hidden" value="2"/>
                <div class="right-content-info">
                    ...
                    <div class="group">
                        ...
                        <input type="text"  name="saccount" class="form-control" placeholder="姓名" maxlength="10" >
                    </div>
                    <div class="group">
                        <div class="group-label">
                            <span>年龄：</span>
                ...
                <div class="right-content-footer">
                    ...
                    <button  type="button" class="btn btn-default" style="width: 80px;height: 35px" onclick="window.location.href='editorList.php?pageindex=<?php echo $_SESSION["pageindex"]-1?>'">返回</button>
                </div>
            </form>
    </div>
</div>
